...
import zhiwenyan.cmccaifu.com.androidadvanced.proxy.IBank;
import zhiwenyan.cmccaifu.com.androidadvanced.proxy.Man;
...
public class Client {
    public static void main(String[] args) {
        ...
        IBank proxy = (IBank) Proxy.newProxyInstance(IBank.class.getClassLoader(),
                new Class<?>[]{IBank.class},  //接口类数组  //man.getClass.
